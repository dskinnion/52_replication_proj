...
png("../graphics/fig2_ext.png")

shapes2<-c(0, 1, 15, 16)

colors2 <- c("#6691FF", "#785EF0", "#DC267F", "#FE6100")
...
plot(x=plot_1[,1],y=c(73:70),xlim=c(-5,5),ylim=c(1,73),pch=shapes2,col=colors2,yaxt="n",xlab="Coefficient Estimate",ylab="",cex=0.8)
segments(x0=plot_1[,2],y0=c(73:70),x1=plot_1[,3],y1=c(73:70),col=colors2)
points(x=plot_5[,1],y=c(67:64),pch=shapes2,col=colors2)
segments(x0=plot_5[,2],y0=c(67:64),x1=plot_5[,3],y1=c(67:64),col=colors2)
points(x=plot_10[,1],y=c(61:58),pch=shapes2,col=colors2)
segments(x0=plot_10[,2],y0=c(61:58),x1=plot_10[,3],y1=c(61:58),col=colors2)
abline(h=56)

plot_1<-plotty_dem1
plot_5<-plotty_dem5
plot_10<-plotty_dem10
points(x=plot_1[,1],y=c(54:51),pch=shapes2,col=colors2)
segments(x0=plot_1[,2],y0=c(54:51),x1=plot_1[,3],y1=c(54:51),col=colors2)
points(x=plot_5[,1],y=c(48:45),pch=shapes2,col=colors2)
segments(x0=plot_5[,2],y0=c(48:45),x1=plot_5[,3],y1=c(48:45),col=colors2)
points(x=plot_10[,1],y=c(42:39),pch=shapes2,col=colors2)
segments(x0=plot_10[,2],y0=c(42:39),x1=plot_10[,3],y1=c(42:39),col=colors2)
abline(h=37)

plot_1<-plotty_rc1
plot_5<-plotty_rc5
plot_10<-plotty_rc10
points(x=plot_1[,1],y=c(35:32),pch=shapes2,col=colors2)
segments(x0=plot_1[,2],y0=c(35:32),x1=plot_1[,3],y1=c(35:32),col=colors2)
points(x=plot_5[,1],y=c(29:26),pch=shapes2,col=colors2)
segments(x0=plot_5[,2],y0=c(29:26),x1=plot_5[,3],y1=c(29:26),col=colors2)
points(x=plot_10[,1],y=c(23:20),pch=shapes2,col=colors2)
segments(x0=plot_10[,2],y0=c(23:20),x1=plot_10[,3],y1=c(23:20),col=colors2)
abline(h=18)

plot_1<-plotty_abs1
plot_5<-plotty_abs5
plot_10<-plotty_abs10
points(x=plot_1[,1],y=c(16:13),pch=shapes2,col=colors2)
segments(x0=plot_1[,2],y0=c(16:13),x1=plot_1[,3],y1=c(16:13),col=colors2)
points(x=plot_5[,1],y=c(10:7),pch=shapes2,col=colors2)
segments(x0=plot_5[,2],y0=c(10:7),x1=plot_5[,3],y1=c(10:7),col=colors2)
points(x=plot_10[,1],y=c(4:1),pch=shapes2,col=colors2)
segments(x0=plot_10[,2],y0=c(4:1),x1=plot_10[,3],y1=c(4:1),col=colors2)

abline(v=0,lty=2)

axis(2, at=c(2.5,7.5,12.5,21.5,27.5,33.5,40.5,46.5,52.5,59.5,65.5,71.5),tick=FALSE,labels=rep(c("10yr","5yr","1yr"),4), las=2,cex=0.8)
legend(2.75,72.5,c("No age, no FE","Age, no FE","No age, FE","Age, FE"), pch=shapes2,col=colors2,text.font=3,cex=0.8)
abline(v=0,lty=2)
...
png(file="../graphics/fig_prepostpolity1_ext.png")
plot(death$polity_lag1,death$polity_for1,xlim=c(-10,10),ylim=c(-10,10),ylab="Polity, 1 year after",xlab="Polity, year before", col = colors2[1])
abline(a=0,b=1, col = colors2[2])
abline(a=5,b=1,lty=5, col = colors2[3])
abline(a=-5,b=1,lty=5, col = colors2[3])
s<-subset(death, abs(polity_for1-polity_lag1)>5)

text(8,-8.5,"Greece 1936",cex=0.75, col = colors2[4]) 
text(4,-5.5,"Ethiopia 1930",cex=0.75, col = colors2[4]) 
text(4.2,-2.5,"Comoros 1998",cex=0.75, col = colors2[4]) 
text(2,-9.5,"Paraguay 1940",cex=0.75, col = colors2[4]) 

text(-7,1.5,"Spain 1975",cex=0.75, col = colors2[4]) 
text(-5,8.5,"Croatia 1999",cex=0.75, col = colors2[4]) 
text(-9,0.5,"Greece 1941",cex=0.75, col = colors2[4]) 
text(-9,-1.5,"Bulgaria 1943",cex=0.75, col = colors2[4]) 
text(-6,4.5,"Nigeria 1998",cex=0.75, col = colors2[4]) 
text(-6.1,0.5,"Yemen 1962",cex=0.75, col = colors2[4]) 
dev.off()

png(file="../graphics/fig_prepostpolity5_ext.png")
plot(death$polity_lag1,death$polity_for5,xlim=c(-10,10),ylim=c(-10,10),ylab="Ave. Polity, 5 years after",xlab="Polity, year before", col = colors2[1])
abline(a=0,b=1, col = colors2[2])
abline(a=5,b=1,lty=5, col = colors2[3])
abline(a=-5,b=1,lty=5, col = colors2[3])
s<-subset(death, abs(polity_for5-polity_lag1)>5)
text(-7,7.1,"Spain 1975",cex=0.75, col = colors2[4]) 
text(-5,8.5,"Croatia 1999",cex=0.75, col = colors2[4]) 
text(-8,5.3,"Greece 1941",cex=0.75, col = colors2[4]) 
text(-6,4.5,"Nigeria 1998",cex=0.75, col = colors2[4]) 

text(8,-1.3,"Colombia 1884",cex=0.75, col = colors2[4]) 
text(2,-9.5,"Paraguay 1940",cex=0.75, col = colors2[4]) 
text(6,-5.5,"Argentina 1974",cex=0.75, col = colors2[4]) 
text(8,-6.9,"Greece 1936",cex=0.75, col = colors2[4]) 
text(4,-4.5,"Ethiopia 1930",cex=0.75, col = colors2[4]) 
dev.off()


png(file="../graphics/fig_prepostpolity10_ext.png")
plot(death$polity_lag1,death$polity_for10,xlim=c(-10,10),ylim=c(-10,10),ylab="Ave. Polity, 10 years after",xlab="Polity, year before", col = colors2[1])
abline(a=0,b=1, col = colors2[2])
abline(a=5,b=1,lty=5, col = colors2[3])
abline(a=-5,b=1,lty=5, col = colors2[3])
s<-subset(death, abs(polity_for10-polity_lag1)>5)

text(2,-5.1,"Guatemala 1926",cex=0.6, col = colors2[4]) 
text(8,0.8,"Colombia 1882",cex=0.6, col = colors2[4]) 
text(8,-2.4,"Colombia 1884",cex=0.6, col = colors2[4]) 
text(2,-8,"Paraguay 1940",cex=0.6, col = colors2[4]) 
text(6,-4.4,"Argentina 1974",cex=0.6, col = colors2[4]) 
text(8.6,2.1,"Uruguay 1965",cex=0.6, col = colors2[4]) 
text(8,-1.1,"Uruguay 1967",cex=0.6, col = colors2[4]) 
text(8,-0.3,"Greece 1936",cex=0.6, col = colors2[4]) 
text(5.6,-1.9,"Sierra Leone 1964",cex=0.6, col = colors2[4]) 

text(-7.6,-1.4,"Guyana 1985",cex=0.6, col = colors2[4]) 
text(-7,8.7,"Spain 1975",cex=0.6, col = colors2[4]) 
text(-9.5,-2.3,"Portugal 1968",cex=0.6, col = colors2[4]) 
text(-9.5,-0.9,"Albania 1985",cex=0.6, col = colors2[4]) 
text(-5,9,"Croatia 1999",cex=0.6, col = colors2[4]) 
text(-8,5.7,"Greece 1941",cex=0.6, col = colors2[4]) 
text(-7,-0.5,"Russia 1985",cex=0.6, col = colors2[4]) 
text(-7,0.5,"Niger 1987",cex=0.6, col = colors2[4]) 
text(-6,4.5,"Nigeria 1998",cex=0.6, col = colors2[4]) 
text(-1,5.6,"Taiwan",cex=0.6, col = colors2[4]) 
dev.off()
...
### Figure 1 Extension Continued

png("../graphics/fig_1_ext.png", res = 200, units = "in", width = 10, height = 10)

plot(0:8, 0:8, type = "n", xaxt = "n", yaxt = "n", xlab = "", ylab = "")
rasterImage(readPNG(source="../graphics/fig_prepostpolity1_ext.png"), 0, 4, 4, 8)
rasterImage(readPNG(source="../graphics/fig_prepostpolity5_ext.png"), 4, 4, 8, 8)
rasterImage(readPNG(source="../graphics/fig_prepostpolity10_ext.png"), 0, 0, 4, 4)
text(0, 7.6, "A", cex=2)
text(4, 7.6, "B", cex=2)
text(0, 3.8, "C", cex=2)
dev.off()
...
png(file="../graphics/fig3_ext.png")
par(mfrow=c(3,2))
len<-nrow(summary(marg1_nofe))
confintty<-confi(marg1_nofe,len,0.9)
plot(x=summary(marg1_nofe)$agepre,y=as.numeric(summary(marg1_nofe)$AME),pch=20,xlab="Age",ylab="Average Marginal Effect of Death",ylim=c(-2,1.5),cex=0.8, main="1-Year DV, No Fixed Effects", col = colors2[1])
segments(x0=summary(marg1_nofe)$agepre,
         y0=confintty$lower[1:len],
         x1=summary(marg1_nofe)$agepre,
         y1=confintty$upper[1:len],
...
len<-nrow(summary(marg1_fe))
confintty<-confi(marg1_fe,len,0.9)
plot(x=summary(marg1_fe)$agepre,y=as.numeric(summary(marg1_fe)$AME),pch=20,xlab="Age",ylab="Average Marginal Effect of Death",ylim=c(-2,1.5),cex=0.8, main="1-Year DV, Fixed Effects", col = colors2[1])
segments(x0=summary(marg1_fe)$agepre,
         y0=confintty$lower[1:len],
         x1=summary(marg1_fe)$agepre,
         y1=confintty$upper[1:len], 
...
len<-nrow(summary(marg5_nofe))
confintty<-confi(marg5_nofe,len,0.9)
plot(x=summary(marg5_nofe)$agepre,y=as.numeric(summary(marg5_nofe)$AME),pch=20,xlab="Age",ylab="Average Marginal Effect of Death",ylim=c(-2,1.5),cex=0.8, main="5-Year DV, No Fixed Effects", col = colors2[1])
segments(x0=summary(marg5_nofe)$agepre,
         y0=confintty$lower[1:len],
         x1=summary(marg5_nofe)$agepre,
         y1=confintty$upper[1:len], 
...
len<-nrow(summary(marg5_fe))
confintty<-confi(marg5_fe,len,0.9)
plot(x=summary(marg5_fe)$agepre,y=as.numeric(summary(marg5_fe)$AME),pch=20,xlab="Age",ylab="Average Marginal Effect of Death",ylim=c(-2,1.5),cex=0.8, main="5-Year DV, Fixed Effects", col = colors2[1])
segments(x0=summary(marg5_fe)$agepre,
         y0=confintty$lower[1:len],
         x1=summary(marg5_fe)$agepre,
         y1=confintty$upper[1:len], 
...
len<-nrow(summary(marg10_nofe))
confintty<-confi(marg10_nofe,len,0.9)
plot(x=summary(marg10_nofe)$agepre,y=as.numeric(summary(marg10_nofe)$AME),pch=20,xlab="Age",ylab="Average Marginal Effect of Death",ylim=c(-2,1.5),cex=0.8, main="10-Year DV, No Fixed Effects", col = colors2[1])
segments(x0=summary(marg10_nofe)$agepre,
         y0=confintty$lower[1:len],
         x1=summary(marg10_nofe)$agepre,
         y1=confintty$upper[1:len], 
...
len<-nrow(summary(marg10_fe))
confintty<-confi(marg10_fe,len,0.9)
plot(x=summary(marg10_fe)$agepre,y=as.numeric(summary(marg10_fe)$AME),pch=20,xlab="Age",ylab="Average Marginal Effect of Death",ylim=c(-2,1.5),cex=0.8, main="10-Year DV, Fixed Effects", col = colors2[1])
segments(x0=summary(marg10_fe)$agepre,
         y0=confintty$lower[1:len],
         x1=summary(marg10_fe)$agepre,
         y1=confintty$upper[1:len], 
...
png(file="../graphics/fig4_ext.png")
par(mfrow=c(3,2))
...
confintty0<-confi(marg1_nofe,l1,0,0.9)
confintty1<-confi(marg1_nofe,l1,1,0.9)
plot(x=summary(marg1_nofe)$agepre[1:l1],y=summary(marg1_nofe)$AME[1:l1],pch=20,xlab="Age",ylab="Average Marginal Effect of Death",ylim=c(-10,10),cex=0.8, main="1-Year DV, No Fixed Effects", col=colors2[2])
segments(	x0=summary(marg1_nofe)$agepre[1:l1],
			y0=confintty0$lower[1:l1],
			x1=summary(marg1_nofe)$agepre[1:l1],
			y1=confintty0$upper[1:l1],
			col = colors2[1])
points(x=summary(marg1_nofe)$agepre[l2:len],y=summary(marg1_nofe)$AME[l2:len],pch=20, col = colors2[3])
segments(	x0=summary(marg1_nofe)$agepre[1:l1],
			y0=confintty1$lower[1:l1],
			x1=summary(marg1_nofe)$agepre[1:l1],
			y1=confintty1$upper[1:l1],
			col = colors2[4])
abline(h=0)
legend(41,9,c("Non-Personalist","Personalist"), pch=19,col=c(colors2[2],colors2[3]),text.font=3,cex=0.8)
...
confintty0<-confi(marg1_fe,l1,0,0.9)
confintty1<-confi(marg1_fe,l1,1,0.9)
plot(x=summary(marg1_fe)$agepre[1:l1],y=summary(marg1_fe)$AME[1:l1],pch=20,xlab="Age",ylab="Average Marginal Effect of Death",ylim=c(-10,10),cex=0.8, main="1-Year DV, Fixed Effects", col=colors2[2])
segments(	x0=summary(marg1_nofe)$agepre[1:l1],
			y0=confintty0$lower[1:l1],
			x1=summary(marg1_nofe)$agepre[1:l1],
			y1=confintty0$upper[1:l1],
			col = colors2[1])
points(x=summary(marg1_fe)$agepre[l2:len],y=summary(marg1_fe)$AME[l2:len],pch=20, col = colors2[3])
segments(	x0=summary(marg1_fe)$agepre[1:l1],
			y0=confintty1$lower[1:l1],
			x1=summary(marg1_fe)$agepre[1:l1],
			y1=confintty1$upper[1:l1],
...
confintty0<-confi(marg5_nofe,l1,0,0.9)
confintty1<-confi(marg5_nofe,l1,1,0.9)
plot(x=summary(marg5_nofe)$agepre[1:l1],y=summary(marg5_nofe)$AME[1:l1],pch=20,xlab="Age",ylab="Average Marginal Effect of Death",ylim=c(-10,10),cex=0.8, main="5-Year DV, No Fixed Effects", col=colors2[2])
segments(	x0=summary(marg5_nofe)$agepre[1:l1],
			y0=confintty0$lower[1:l1],
			x1=summary(marg5_nofe)$agepre[1:l1],
			y1=confintty0$upper[1:l1],
			col = colors2[1])
points(x=summary(marg5_nofe)$agepre[l2:len],y=summary(marg5_nofe)$AME[l2:len],pch=20, col = colors2[3])
segments(	x0=summary(marg5_nofe)$agepre[1:l1],
			y0=confintty1$lower[1:l1],
			x1=summary(marg5_nofe)$agepre[1:l1],
			y1=confintty1$upper[1:l1],
...
confintty0<-confi(marg5_fe,l1,0,0.9)
confintty1<-confi(marg5_fe,l1,1,0.9)
plot(x=summary(marg5_fe)$agepre[1:l1],y=summary(marg5_fe)$AME[1:l1],pch=20,xlab="Age",ylab="Average Marginal Effect of Death",ylim=c(-10,10),cex=0.8, main="5-Year DV, Fixed Effects", col=colors2[2])
segments(	x0=summary(marg5_fe)$agepre[1:l1],
			y0=confintty0$lower[1:l1],
			x1=summary(marg5_fe)$agepre[1:l1],
			y1=confintty0$upper[1:l1],
			col = colors2[1])
points(x=summary(marg5_fe)$agepre[l2:len],y=summary(marg5_fe)$AME[l2:len],pch=20, col = colors2[3])
segments(	x0=summary(marg5_fe)$agepre[1:l1],
			y0=confintty1$lower[1:l1],
			x1=summary(marg5_fe)$agepre[1:l1],
			y1=confintty1$upper[1:l1],
...
confintty0<-confi(marg10_nofe,l1,0,0.9)
confintty1<-confi(marg10_nofe,l1,1,0.9)
plot(x=summary(marg10_nofe)$agepre[1:l1],y=summary(marg10_nofe)$AME[1:l1],pch=20,xlab="Age",ylab="Average Marginal Effect of Death",ylim=c(-10,10),cex=0.8, main="10-Year DV, No Fixed Effects", col=colors2[2])
segments(	x0=summary(marg10_nofe)$agepre[1:l1],
			y0=confintty0$lower[1:l1],
			x1=summary(marg10_nofe)$agepre[1:l1],
			y1=confintty0$upper[1:l1],
			col = colors2[1])
points(x=summary(marg10_nofe)$agepre[l2:len],y=summary(marg10_nofe)$AME[l2:len],pch=20, col = colors2[3])
segments(	x0=summary(marg10_nofe)$agepre[1:l1],
			y0=confintty1$lower[1:l1],
			x1=summary(marg10_nofe)$agepre[1:l1],
			y1=confintty1$upper[1:l1],
...
confintty0<-confi(marg10_fe,l1,0,0.9)
confintty1<-confi(marg10_fe,l1,1,0.9)
plot(x=summary(marg10_fe)$agepre[1:l1],y=summary(marg10_fe)$AME[1:l1],pch=20,xlab="Age",ylab="Average Marginal Effect of Death",ylim=c(-10,10),cex=0.8, main="10-Year DV, Fixed Effects", col=colors2[2])
segments(	x0=summary(marg10_fe)$agepre[1:l1],
			y0=confintty0$lower[1:l1],
			x1=summary(marg10_fe)$agepre[1:l1],
			y1=confintty0$upper[1:l1],
			col = colors2[1])
points(x=summary(marg10_fe)$agepre[l2:len],y=summary(marg10_fe)$AME[l2:len],pch=20, col = colors2[3])
segments(	x0=summary(marg10_fe)$agepre[1:l1],
			y0=confintty1$lower[1:l1],
			x1=summary(marg10_fe)$agepre[1:l1],
			y1=confintty1$upper[1:l1],
...
png(file="../graphics/fig5_ext.png")
barplot(height=plotty,col=colors2, beside=T, legend=c("death","irreg","reg","dem"), ylim=c(0,0.6))
dev.off()
...
## Figure for H2b (Figure 6 in Main Article)
png(file="../graphics/fig6_ext.png")
par(mfrow=c(2,1))
...
plot(age,eff1_p,ylim=c(0,0.4),type="l",ylab="Predicted Probability",xlab="Leader Age",main="DV: Attempted Coup", col='black')
cord.x<-c(age[1],age[1],age,age[length(age)],age[length(age)],rev(age))
cord.y<-c(upper_p[1],lower_p[1],lower_p,lower_p[length(age)],upper_p[length(age)],rev(upper_p))
polygon(cord.x,cord.y, col=rgb(100/255,143/255,255/255,alpha=0.6))
lines(age,eff1_n, col='black')
cord.x<-c(age[1],age[1],age,age[length(age)],age[length(age)],rev(age))
cord.y<-c(upper_n[1],lower_n[1],lower_n,lower_n[length(age)],upper_n[length(age)],rev(upper_n))
polygon(cord.x,cord.y,col=rgb(254/255,97/255,0/255,alpha=0.6))
legend(52,0.385,c("Personalist","Non-Personalist"), pch=19,col=c(rgb(100/255,143/255,255/255,alpha=0.6), rgb(254/255,97/255,0/255,alpha=0.6)),text.font=3,cex=0.8)
...
plot(age,eff1_p,ylim=c(0,0.4),type="l",ylab="Predicted Probability",xlab="Leader Age",main="DV: Irregular Exit",col='black')
cord.x<-c(age[1],age[1],age,age[length(age)],age[length(age)],rev(age))
cord.y<-c(upper_p[1],lower_p[1],lower_p,lower_p[length(age)],upper_p[length(age)],rev(upper_p))
polygon(cord.x,cord.y,col=rgb(100/255,143/255,255/255,alpha=0.6))
lines(age,eff1_n,col='black')
cord.x<-c(age[1],age[1],age,age[length(age)],age[length(age)],rev(age))
cord.y<-c(upper_n[1],lower_n[1],lower_n,lower_n[length(age)],upper_n[length(age)],rev(upper_n))
polygon(cord.x,cord.y,col=rgb(254/255,97/255,0,alpha=0.6))
legend(52,0.385,c("Personalist","Non-Personalist"), pch=19,col=c(rgb(100/255,143/255,255/255,alpha=0.6), rgb(254/255,97/255,0,alpha=0.6)),text.font=3,cex=0.8)
...
png(file="../graphics/fig7_ext.png")
par(mfrow=c(2,2))
...
polygon(cord.x,cord.y,col=rgb(254/255,97/255,0,alpha=0.6))
abline(h=1.1)
legend(fit_old$time[xmax]-6,1.05,legend=c("Young","Old"),pch=19,col=c(rgb(100/255,143/255,255/255,alpha=0.6),rgb(254/255,97/255,0,alpha=0.6)))
text(3.5,1.17,c("Non-Personalist Regimes"),vfont=c("sans serif","bold italic"),pos=4)
...
png(file="../graphics/fig8_ext.png")
par(mfrow=c(3,2))
...
segments(	x0=summary(marg1_nofe)$agepre[1:l1],
			y0=confintty1$lower[1:l1],
			x1=summary(marg1_nofe)$agepre[1:l1],
			y1=confintty1$upper[1:l1], col=colors2[4])
abline(h=0)
legend(60,9,c("Low-Development","High-Development"), pch=19,col=c(colors2[2],colors2[3]),text.font=3,cex=0.8)
...
segments(	x0=summary(marg1_fe)$agepre[1:l1],
			y0=confintty0$lower[1:l1],
			x1=summary(marg1_fe)$agepre[1:l1],
			y1=confintty0$upper[1:l1], col=colors2[1])
points(x=summary(marg1_fe)$agepre[l2:len],y=summary(marg1_fe)$AME[l2:len],pch=20, col=colors2[3])
segments(	x0=summary(marg1_fe)$agepre[1:l1],
			y0=confintty1$lower[1:l1],
			x1=summary(marg1_fe)$agepre[1:l1],
...
segments(	x0=summary(marg5_nofe)$agepre[1:l1],
			...
			y1=confintty1$upper[1:l1], col=colors2[4])
abline(h=0)
legend(59.4,9,c("Low-Development","High-Development"), pch=19,col=c(colors2[2],colors2[3]),text.font=3,cex=0.8)
...
segments(	x0=summary(marg10_nofe)$agepre[1:l1],
			...
			y1=confintty1$upper[1:l1], col=colors2[4])
abline(h=0)
legend(58.4,9,c("Low-Development","High-Development"), col=c(colors2[2],colors2[3]),text.font=3,cex=0.8)
...
segments(	x0=summary(marg10_fe)$agepre[1:l1],
			...
			y1=confintty1$upper[1:l1], col=colors2[4])
abline(h=0)
legend(58.4,9,c("Low-Development","High-Development"), pch=19,col=c(colors2[2],colors2[3]),text.font=3,cex=0.8)
...
png(file="../graphics/fig9_ext.png")
barplot(height=plotty,col=colors2, beside=T, legend=c("death","irreg","reg","dem"), ylim=c(0,0.6),names.arg=c("high development", "low development"))
dev.off()
